...
public class BinaryTree_traversals {
   ...
   int count=0;
    ...
    public boolean ancestors(Node root,int value){

        if(root==null)
            return false;
        if(root.data==value) //node given here whose ancestors to be found
        {
    ...
    public static void main(String[] args) {
        BinaryTree_traversals tree=new BinaryTree_traversals(0);
...
//        System.out.println(tree.height);
  ...
  //      tree.insert(tree.root, 444);
    //    tree.Inorder(tree.root);
      //  tree.ancestors(tree.root, 7);
        System.out.println();
    }
}
